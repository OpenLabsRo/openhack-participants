...
import { teamRune, teamMembersRune, createTeam, join, leave, kick, deleteTeam, changeTeamName, loadMembers, } from '../runes/teamRune.js';
...
async function runRuneTests() {
    ...
    openhackApi.Teams.create = async (name) => ({
        token: 'tkn',
        account: sampleAccount,
    });
    ...
    try {
        ...
        const changedTeamName = get(teamRune);
        if (!changedTeamName)
